...
public class WSYtelseskontrakt 
{
    ...
    @XmlElement(required = true)
    protected List<no.nav.tjeneste.virksomhet.ytelseskontrakt.v3.informasjon.ytelseskontrakt.WSVedtak> ihtVedtak;
     ...
     * {@link no.nav.tjeneste.virksomhet.ytelseskontrakt.v3.informasjon.ytelseskontrakt.WSVedtak }
     * 
     * 
     */
    public List<no.nav.tjeneste.virksomhet.ytelseskontrakt.v3.informasjon.ytelseskontrakt.WSVedtak> getIhtVedtak() {
        if (ihtVedtak == null) {
            ihtVedtak = new ArrayList<no.nav.tjeneste.virksomhet.ytelseskontrakt.v3.informasjon.ytelseskontrakt.WSVedtak>();
        }
    ...
    public WSYtelseskontrakt withIhtVedtak(no.nav.tjeneste.virksomhet.ytelseskontrakt.v3.informasjon.ytelseskontrakt.WSVedtak... values) {
        if (values!= null) {
            for (no.nav.tjeneste.virksomhet.ytelseskontrakt.v3.informasjon.ytelseskontrakt.WSVedtak value: values) {
