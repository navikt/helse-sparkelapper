...
internal object PersonhendelseFactory {
    ...
    internal fun adressebeskyttelse(
        ...
        GenericData.Record(sisteSkjema).apply {
            val addressebeskyttelseSchema =
                sisteSkjema
                    .getField("adressebeskyttelse")
                    .schema()
                    .types
                    .last()
            val deltBostedSchema =
                sisteSkjema
                    .getField("deltBosted")
                    .schema()
                    .types
            ...
            put(
                "adressebeskyttelse",
                GenericData.Record(addressebeskyttelseSchema).apply {
    ...
    internal fun navn(
        ...
        GenericData.Record(sisteSkjema).apply {
            ...
            put(
                "navn",
                GenericData.Record(navnSkjema).apply {
                    put("fornavn", "SKY")
    ...
    internal fun folkeregisteridentifikator(
        ...
        GenericData.Record(sisteSkjema).apply {
            ...
            val schema =
                sisteSkjema
                    .getField("Folkeregisteridentifikator")
                    .schema()
                    .types
                    .last()
            put(
