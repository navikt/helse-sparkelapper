...
internal class PersonhendelseRiver(
    ...
    private fun håndterDødsmelding(
    ...
    private fun håndterFolkeregisteridentifikator(
        record: GenericRecord,
        callId: String,
    ) {
        ...
        val packet =
            JsonMessage.newMessage(
                ...
                mapOf(
                    ...
                    "gamle_identer" to
                        historiskeIdenter.fødselsnumre.map {
                            mapOf(
    ...
    private fun håndterAdressebeskyttelse(
        record: GenericRecord,
        callId: String,
    ) {
