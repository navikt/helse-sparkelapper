...
class PersonhendelseAvroDeserializer : Deserializer<GenericRecord> {
    ...
    companion object {
        private val logg = LoggerFactory.getLogger(PersonhendelseAvroDeserializer::class.java)
        private val sikkerlogg = LoggerFactory.getLogger("tjenestekall")
        private val schemaVersjon = (System.getenv("PERSONHENDELSE_VERSJON") ?: "V11").also {
            logg.info("Bruker $it av Personhendelse fra Leesah.")
        }
