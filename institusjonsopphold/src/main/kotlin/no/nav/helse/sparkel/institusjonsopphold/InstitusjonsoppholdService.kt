...
internal class InstitusjonsoppholdService(
    private val institusjonsoppholdClient: InstitusjonsoppholdClient,
) {
    ...
    fun løsningForBehov(
        ...
        withMDC("id" to behovId, "vedtaksperiodeId" to vedtaksperiodeId) {
            try {
                val institusjonsopphold =
                    institusjonsoppholdClient.hentInstitusjonsopphold(
